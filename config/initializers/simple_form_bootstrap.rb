...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'input', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_radio_and_checkboxes, tag: 'div', class: 'input', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
